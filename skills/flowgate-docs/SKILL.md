...
# flowgate-docs —— 产出功能文档清单与生成记录 09-docs.md。
...
python3 "${CLAUDE_PLUGIN_ROOT}/scripts/flowgate_state.py" instructions 09-docs --json  # 本阶段 context/rules/模板/依赖/Tier2 技能
python3 "${CLAUDE_PLUGIN_ROOT}/scripts/flowgate_state.py" validate --json            # 产物自检
```

## 产物

写入 `.flowgate/` 下 `09-docs` 对应产物，模板见 `references/templates/09-docs.md`。
